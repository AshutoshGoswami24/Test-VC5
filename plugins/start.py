...
async def Handle_StartMsg(bot:Client, msg:Message):
    ...
    if msg.chat.type == enums.ChatType.SUPERGROUP and not await db.is_user_exist(msg.from_user.id):
        ...
        btn = [
            ...
            [InlineKeyboardButton(text='❤️ 𝗠𝗮𝗶𝗻 𝗖𝗵𝗮𝗻𝗻𝗮𝗹 ❤️', url='https://t.me/PandaWep')]
        ]
        ...
        btn = [
            ...
            [InlineKeyboardButton(text='😁 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ 😁', url='https://t.me/PandaWepChat'), InlineKeyboardButton(text='❤️ 𝗠𝗮𝗶𝗻 𝗖𝗵𝗮𝗻𝗻𝗮𝗹 ❤️ ', url='https://t.me/PandaWep')]
        ]
